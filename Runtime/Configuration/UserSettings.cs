...
namespace Teo.AutoReference.Configuration {
    internal static class UserSettings {
        ...
        private static readonly Color32 DefaultExceptionNameColor = new(255, 102, 102, 255);
        private static readonly Color32 DefaultMessageColor = new(255, 255, 102, 255);
        private static readonly Color32 DefaultSymbolColor = new(77, 255, 235, 255);
        private static readonly Color32 DefaultDefaultColor = new(255, 255, 255, 255);

        private static FormatInfo DefaultExceptionNameInfo { get; } = new(DefaultExceptionNameColor);
        private static FormatInfo DefaultMessageInfo { get; } = new(DefaultMessageColor);
        private static FormatInfo DefaultSymbolInfo { get; } = new(DefaultSymbolColor);
        private static FormatInfo DefaultDefaultInfo { get; } = new(DefaultDefaultColor);

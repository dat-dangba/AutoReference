...
namespace Teo.AutoReference.Internals {
    ...
    /// </summary>
    internal static class AutoReferenceResolver {
        ...
        private static ValidationResult IsAutoField(FieldInfo field) {
            var type = ObjectField.GetUnderlyingType(field.FieldType);
            ...
            return ValidationResult.Warning("Field must be a Unity object or a list/array of a Unity object");
        }
        ...
        /// </summary>
        public static AutoReferenceTypeInfo GetAutoReferenceInfo(Type type) {
            ...
            foreach (var field in GetAllRelevantFields(type)) {
                ...
                } else if (hasSyncCallbacks && field.MightBeSerializable()) {
        ...
        /// attached to it.
        /// </summary>
        private static AutoReferenceField GetAutoField(Type type,
            FieldInfo info,
        ...
        /// <summary>
        /// Retrieves all methods with the 'OnAfterSync' attribute in a given type and its base types.
        /// </summary>

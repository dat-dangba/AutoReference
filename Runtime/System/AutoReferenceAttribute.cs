...
namespace Teo.AutoReference.System {
    ...
    public abstract class AutoReferenceAttribute : AutoReferenceBaseAttribute {
        ...
        private SyncResult DoGetIfEmpty() {
        ...
        private SyncResult DoValidateOrGetIfEmpty() {
        ...
        private SyncResult DoAlwaysGetAndValidate() {
        ...
        private SyncResult GetSyncedValues() {
            switch (SyncMode) {
                case SyncMode.Default when Field.IsPlain:
                    goto case SyncMode.ValidateOrGetIfEmpty;
                case SyncMode.Default when Field.IsArrayOrList:
                    goto case SyncMode.AlwaysGetAndValidate;
                case SyncMode.ValidateOnly:
                    return DoValidateOnly();
                case SyncMode.GetIfEmpty:
                    return DoGetIfEmpty();
                case SyncMode.ValidateOrGetIfEmpty:
                    return DoValidateOrGetIfEmpty();
                case SyncMode.AlwaysGetAndValidate:
                    return DoAlwaysGetAndValidate();
                default:
                    return null;
            }
        }

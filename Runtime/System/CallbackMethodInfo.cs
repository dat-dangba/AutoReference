    ...
    public readonly struct CallbackMethodInfo {
        ...
        private static string FormatParameter(ParameterInfo arg) {
            if (arg.HasDefaultValue) {
                return $"{arg.ParameterType.FormatCSharpName()}={arg.DefaultValue}";
            }

            return arg.ParameterType.FormatCSharpName();
        }
        ...
        internal static CallbackMethodInfo Create(
            ...
            if (string.IsNullOrWhiteSpace(methodName)) {
                return new CallbackMethodInfo("Method name not provided");
            }

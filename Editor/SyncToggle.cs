...
namespace Teo.AutoReference.Editor {
    ...
    public static class SyncToggle {
        ...
        private static readonly GUIContent OnContent = new("", ToolTipOn);
        private static readonly GUIContent OffContent = new("", ToolTipOff);

        private static readonly GUIContent OnContentText = new("A", ToolTipOn);
        private static readonly GUIContent OffContentText = new("A", ToolTipOff);
        ...
        public static bool Draw(Vector2 position, bool value) {
            ...
            StyleInfo info = style switch {
                Style.TextOnly => (toggle: false, text: true, GUI.skin.label),
